...
export class MemStorage implements IStorage {
  ...
  private initializeProductsAndVariants() {
    const mainProduct: Product = {
      ...
      name: "Pure Desi Ghee",
      description: "Crafted with 50 years of tradition, our Pure Desi Ghee is made from the finest quality milk, churned to perfection to bring you an authentic taste and aroma. Ideal for cooking, medicinal purposes, and religious ceremonies.",
      is_popular: true,
    };
    ...
    variantsData.forEach(variantData => {
      const variant: ProductVariant = {
        ...
        ...variantData,
        best_value_badge: variantData.best_value_badge === undefined ? null : variantData.best_value_badge,
  ...
  async createOrder(insertOrder: InsertOrder): Promise<Order> {
    ...
    const order: Order = {
      ...
      paymentStatus: insertOrder.paymentStatus === undefined ? "pending" : insertOrder.paymentStatus || "pending",
      razorpayOrderId: insertOrder.razorpayOrderId === undefined ? null : insertOrder.razorpayOrderId,
      ...insertOrder,
    };
