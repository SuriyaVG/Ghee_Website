        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="firstName" className="text-deep-brown">
                      First Name
                    </Label>
                    <Input
                      id="firstName"
                  ...
                  <div>
                    <Label htmlFor="lastName" className="text-deep-brown">
                      Last Name
                    </Label>
                    <Input
                      id="lastName"
                ...
                <div>
                  <Label htmlFor="email" className="text-deep-brown">
                    Email
                  </Label>
                  <Input
                    id="email"
                ...
                <div>
                  <Label htmlFor="phone" className="text-deep-brown">
                    Phone
                  </Label>
                  <Input
                    id="phone"
                ...
                <div>
                  <Label htmlFor="message" className="text-deep-brown">
                    Message
                  </Label>
                  <Textarea
                    id="message"
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-cream-bg border border-warm-gold/20">
              <CardContent className="p-8">
                <h3 className="text-2xl font-playfair font-bold text-deep-brown mb-4">
                  Quick Order
                </h3>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <a href="https://wa.me/919994287614">
