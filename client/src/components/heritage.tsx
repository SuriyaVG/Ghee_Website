  ...
  return (
    <section id="heritage" className="py-20 bg-warm-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              {timelineItems.map((item, index) => (
                ...
                >
                  <div
                    className={`w-14 h-14 ${item.bgColor} rounded-full flex items-center justify-center flex-shrink-0 mt-1 shadow-lg`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-rich-earth leading-relaxed">{item.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="relative">
            <Image
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-deep-brown/60 to-transparent rounded-2xl"></div>
        ...
        <div className="bg-card rounded-2xl p-8 shadow-premium-lg border border-border">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {familyValues.map((value, index) => (
              ...
              >
                ...
                <p className="text-rich-earth leading-relaxed">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
